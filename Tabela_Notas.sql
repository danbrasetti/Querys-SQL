...
ID_do_Aluno INT,
Valor_da_Nota FLOAT,
Data_da_Avaliacao VARCHAR (20),

FOREIGN KEY (ID_do_Aluno) REFERENCES alunos (ID_do_Aluno),
FOREIGN KEY (ID_da_Disciplina) REFERENCES disciplinas (ID_Disciplina)
);

INSERT INTO Notas 
(ID_da_Nota, ID_da_disciplina, ID_do_Aluno, Valor_da_Nota, Data_da_Avaliacao)
VALUES
...
('11', '1', '10','3.28', '2023-07-09'),
('12', '2', '1','1.34', '2023-07-07'),
